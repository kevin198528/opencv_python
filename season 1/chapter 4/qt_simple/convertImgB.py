...
# Form implementation generated from reading ui file 'convertB.ui'
#
...
class Ui_openimage(object):
    def setupUi(self, openimage):
        ...
        self.readButton.setGeometry(QtCore.QRect(60, 390, 99, 27))
        self.readButton.setObjectName("readButton")

        self.convertButton = QtWidgets.QPushButton(self.centralwidget)
        self.convertButton.setGeometry(QtCore.QRect(270, 230, 99, 27))
        self.convertButton.setObjectName("convertButton")

        self.label_blue = QtWidgets.QLabel(self.centralwidget)
        self.label_blue.setGeometry(QtCore.QRect(520, 60, 191, 181))
        self.label_blue.setObjectName("label_blue")

        self.label_green = QtWidgets.QLabel(self.centralwidget)
        self.label_green.setGeometry(QtCore.QRect(460, 120, 211, 221))
        self.label_green.setObjectName("label_green")

        self.label_red = QtWidgets.QLabel(self.centralwidget)
        self.label_red.setGeometry(QtCore.QRect(400, 230, 221, 201))
    ...
    def retranslateUi(self, openimage):
        ...
        openimage.setWindowTitle(_translate("openimage", "RGB三原色分离"))
        self.label_raw.setText(_translate("openimage", "图片"))
